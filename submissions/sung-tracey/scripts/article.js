(function(module) {
  ...
  Article.createTable = function(callback) {
    webDB.execute(
      'CREATE TABLE IF NOT EXISTS articles (title VARCHAR, author VARCHAR, authorUrl VARCHAR, category VARCHAR, publishedOn DATETIME, body TEXT, id INTEGER PRIMARY KEY);', // what SQL command do we run here inside these quotes?
      function(result) {
      ...
      if (rows.length) {
        ...
        $.getJSON('/data/hackerIpsum.json', function(data) {
          ...
          data.forEach(function(obj) {
            ...
            // INSERT INTO articles (title, category, author, authorUrl, publishedOn, body) VALUES (obj.title, obj.category, obj.author, obj.authorUrl, obj.publishedOn, obj.body);
